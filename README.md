# Telos EVM Token Creation Tool

A simple frontend tool to create tokens on the Telos EVM (TLOS) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Telos-EVM-TLOS-Token-Creation-Tool-Without-Coding.git
- And press deploy
- Congrats your Telos EVM Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Telos-EVM-TLOS-Token-Creation-Tool-Without-Coding
- Upload into your Github repo.
- Edit the file public/config.json and insert your Telos EVM wallet address for receiving fees. Also set fee in TLOS that you want to charge
